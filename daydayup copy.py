...
# 1. 身份凭证（必填）
# TOKEN = "oRjsg6asr0-oCgFLVvrunP9NmGOM"  # 从抓包URL参数复制
# JSESSIONID = "7684B1E6150ED89ACB6916B8FA8847E2"  # 从Cookie复制
# CARD_INDEX = "1894101490"  # 会员卡号
# REAL_NAME = "陈启轩"  # 预约人姓名（用于日志显示）
...
# python daydayup.py -k oRjsg6asr0-oCgFLVvrunP9NmGOM -j 7684B1E6150ED89ACB6916B8FA8847E2 -i 1894101490 --date 2026-02-02 -t 16-18 --force
