...
示例:
  ...
  python enhanced_book_smart.py -k TOKEN -j JSESSIONID -i CARDINDEX --in-days 4 -t 17-21 --duration 2 --force
    ...
    parser.add_argument("-k", "--token", default=os.getenv("DAYDAYUP_TOKEN", ""), help="token")
    parser.add_argument("-j", "--jsessionid", default=os.getenv("DAYDAYUP_JSESSIONID", ""), help="JSESSIONID")
    parser.add_argument("-i", "--card-index", default=os.getenv("DAYDAYUP_CARD_INDEX", ""), help="card index / offer id")
    ...
    parser.add_argument("--backup", nargs="+", type=int, default=[2, 3, 10, 11], help="backup 场地编号")
